...
export function TableView({
  ...
  return (
    <section className="relative mb-5 flex min-h-[160px] items-center justify-center overflow-hidden rounded-2xl bg-surface-container-low p-3 md:mb-6 md:min-h-[210px] md:rounded-3xl md:p-4">
      ...
      <div className="relative z-10 flex w-full flex-col items-center gap-3 md:gap-4">
        <div className="flex w-full max-w-2xl flex-wrap justify-center gap-2 md:max-w-3xl md:gap-3">
          {renderSeats(top)}
        </div>

        <div className="flex w-full max-w-[16.5rem] flex-col items-center justify-center gap-1.5 rounded-lg border border-outline-variant/10 bg-surface-container/80 px-3 py-3 backdrop-blur-sm md:max-w-sm md:gap-2 md:rounded-xl md:px-4 md:py-3.5">
          {children}
        </div>
